...
urlpatterns = [
    ...
    path("release-entry/api/batches/update-status/", release_entry_views.release_entry_batch_update_status, name="release_entry_batch_update_status"),
    path("release-entry/api/items/", release_entry_views.release_entry_item_list, name="release_entry_item_list"),
    path("release-entry/export.xlsx", release_entry_views.release_entry_export_xlsx, name="release_entry_export_xlsx"),
    ...
    path("release-entry/api/items/confirm/", release_entry_views.release_entry_item_confirm, name="release_entry_item_confirm"),
    path("release-entry/api/items/reject/", release_entry_views.release_entry_item_reject, name="release_entry_item_reject"),
    ...
    path("hobo-ledger/export.xlsx", hobo_ledger_views.hobo_ledger_export_xlsx, name="hobo_ledger_export_xlsx"),
